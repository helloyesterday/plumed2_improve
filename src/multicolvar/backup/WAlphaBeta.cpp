...
//+PLUMEDOC COLVAR WEALPHABETA 
/*
Measures a distance including pbc between the instantaneous values of a set of torsional angles and set of reference as well as weight values.

This colvar calculates the following quantity.

\f[
s = \frac{1}{2} \sum_i w_i \left[ 1 + \cos( \phi_i - \phi_i^{\textrm{Ref}} ) \right]   
\f]
...
The \f$w_i\f$ values are the user-specified weights values for the torsional angles.
...
\verbatim
ALPHABETA ...
ATOMS1=168,170,172,188 REFERENCE1=3.14 WEIGHT1=0.2
ATOMS2=170,172,188,190 REFERENCE2=3.14 WEIGHT1=0.3
ATOMS3=188,190,192,230 REFERENCE3=3.14 WEIGHT1=0.5
LABEL=ab
... ALPHABETA
...
class WeAlphaBeta : public MultiColvar {
private:
...
public:
  ...
  explicit WeAlphaBeta(const ActionOptions&);
  virtual double compute( const unsigned& tindex, AtomValuePack& myatoms ) const ;
  bool isPeriodic(){ return false; }
};

PLUMED_REGISTER_ACTION(WeAlphaBeta,"WEALPHABETA")

void WeAlphaBeta::registerKeywords( Keywords& keys ){
...
WeAlphaBeta::WeAlphaBeta(const ActionOptions&ao):
...
double WeAlphaBeta::compute( const unsigned& tindex, AtomValuePack& myatoms ) const {
